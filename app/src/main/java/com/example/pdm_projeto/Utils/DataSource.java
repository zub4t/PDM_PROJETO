...
public class DataSource {
    ...
    public static List<TimelineItem> getTimeLineData(Context context) {
        ...
        PostTextItem postTextItem = new PostTextItem("Kcal Count: 100", R.drawable.robot, getCurrentTime());
        ...
        postTextItem = new PostTextItem("Kcal Count: 2000", R.drawable.robot, getCurrentTime());
